...
class PCloudApi extends OAuthApi {
  PCloudApi(String identifier, String clientId, String clientSecret,
      String redirectUrl,
      {List<String>? scopes,
        http.Client? client,
        Converter? converter,
  ...
  Authenticator getAuthenticator() => PCloudAuthenticator(identifier, clientId,
      clientSecret, tokenUrl, authorizationUrl, redirectUrl!, scopes, useEmbeddedBrowser);
...
class PCloudAuthenticator extends OAuthAuthenticator {
  ...
  PCloudAuthenticator(String? identifier, String? clientId, String? clientSecret,
      String? tokenUrl, String? baseUrl, String redirectUrl, List<String>? scopes, bool useEmbeddedBrowser)
